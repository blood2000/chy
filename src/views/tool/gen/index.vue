<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" highlight-current-row :data="tableList" @selection-change="handleSelectionChange">
  ...
  methods: {
    ...
    handleGenTable(row) {
      ...
      if (row.genType === '1') {
        ...
        downLoadZip('/code/gen/batchGenCode?tables=' + tableNames, 'ddc');
      }
    },
    /** 同步数据库操作 */
    handleSynchDb(row) {
