    ...
    <el-row>
      <el-col :span="12">
        <el-form-item prop="tplCategory">
          ...
          <el-select v-model="form.tplCategory" clearable filterable>
      ...
      <el-col :span="12">
        <el-form-item prop="packageName">
          <span slot="label">
            生成包路径
            <el-tooltip content="生成在哪个java包下，例如 com.ddc.system" placement="top">
    ...
    <el-row v-show="form.tplCategory == 'tree'">
      ...
      <el-col :span="12">
        <el-form-item>
          ...
          <el-select v-model="form.treeCode" placeholder="请选择" clearable filterable>
            <el-option
      ...
      <el-col :span="12">
        <el-form-item>
          ...
          <el-select v-model="form.treeParentCode" placeholder="请选择" clearable filterable>
            <el-option
              v-for="column in form.columns"
              :key="column.columnName"
              :label="column.columnName + '：' + column.columnComment"
      ...
      <el-col :span="12">
        <el-form-item>
          ...
          <el-select v-model="form.treeName" placeholder="请选择" clearable filterable>
            <el-option
              v-for="column in form.columns"
              :key="column.columnName"
              :label="column.columnName + '：' + column.columnComment"
