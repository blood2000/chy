  ...
  <el-card>
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="字段信息" name="cloum">
        <el-table ref="dragTable" highlight-current-row :data="cloumns" row-key="columnId" :max-height="tableHeight">
          ...
          <el-table-column label="Java类型" min-width="11%">
            <template slot-scope="scope">
              <el-select v-model="scope.row.javaType" clearable filterable>
          ...
          <el-table-column label="显示类型" min-width="12%">
            <template slot-scope="scope">
              <el-select v-model="scope.row.htmlType" clearable filterable>
