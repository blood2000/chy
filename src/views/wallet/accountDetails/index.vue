...
export default {
  ...
  data() {
    return {
      ...
      // payStatus 支付状态:1-支付中 2-支付失败 3-已完成 4-无此交易
      payStatusOptions: [
  ...
  computed: {
    api() {
      // 这个地址只处理表头
      return '/payment/shipmentPaidRecord/accountCapotalList';
    }
  },
  created() {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.download('/payment/shipmentPaidRecord/accountCapotalVoExport', params, `账户明细`).then(() => {
