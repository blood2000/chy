<template>
  <div>
    ...
    <div class="app-container">
      ...
      <RegisterDriver :data="rowData" :open.sync="driverOpen"  @refresh="getList" ></RegisterDriver>
      <RegisterTeam :data="rowData" :open.sync="teamOpen"  @refresh="getList" ></RegisterTeam>
  </div>
</template>
