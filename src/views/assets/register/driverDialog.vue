  ...
  <el-dialog class="i-add" title="新增司机" :visible="visible" width="800px" append-to-body :close-on-click-modal="false" @close="cancel">
    ...
    <el-form ref="vehicleForm" :model="vehicleForm" :rules="vehicleRules" label-width="154px">
      ...
      <template v-if="form.driverType == 1">
        ...
        >
          <el-input-number v-model="vehicleForm.vehicleTotalWeight" :controls="false" :precision="3" :min="0" :max="1000000" placeholder="请输入车辆总重量" class="width90 unit-item" clearable />
        ...
        >
          <el-input-number v-model="vehicleForm.vehicleLoadWeight" :controls="false" :precision="3" :min="0" :max="1000000" placeholder="请输入车辆可载重量" class="width90 unit-item" clearable />
          <span class="unit-span g-color-gray">吨</span>
        </el-form-item>
        ...
        <el-form-item label="车辆可载立方" prop="vehicleRemainingLoadVolume">
          <el-input-number v-model="vehicleForm.vehicleRemainingLoadVolume" :controls="false" :precision="3" :min="0" :max="10000000" placeholder="请输入车辆可载立方" class="width90 unit-item" clearable />
          <span class="unit-span g-color-gray">m³</span>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    // 查询车辆列表
    getVehicleList() {
      this.vehicleQueryParams.licenseNumber = this.vehicleQueryParams.licenseNumber.toUpperCase();
