...
import ThreeMapLightBar from '@/threeMap/ThreeMapLightBar.js';
import { util } from '@/threeMap/util';
...
export default {
  ...
  mounted() {
    ...
    const d = require('@/threeMap/map/china.json');
    ...
    // 绘制光柱
    map.drawLightBar(this.datas);
    // 绘制线条
    map.drawFlyLine(this.flyDatas);
    // map.setArcCurve();
  },
  beforeDestroy() {
...
.g-statistic {
  ...
  box-sizing: border-box;
  background: #040728 url('~@/threeMap/images/map_bg.png') no-repeat;
