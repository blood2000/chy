      ...
      <el-form :ref="`formData`" :model="formData" :rules="rules" :size="formConfig.size" :label-width="formConfig.labelWidth" :label-position="formConfig.labelPosition">
            <el-form-item label="货物计量单位" prop="goodsUnit">
                    <el-select v-model="formData.goodsUnit" placeholder="请选择货物计量单位" clearable :style="{width: '100%'}">
                        ...
                        <el-option label="立方米" :value="2"></el-option>
                    </el-select>
            </el-form-item>
            <el-form-item label="货物总量" prop="weight">
                <el-radio-group v-model="formData.weightType" size="medium">
                    ...
                    <el-radio :label="1">
                            共 <el-input-number v-model="formData.weight" placeholder="请输入重量(吨)" step-strictly controls-position=right :style="{width: '120px'}"></el-input-number>  吨
                    </el-radio>
                </el-radio-group>
            </el-form-item>

                <el-form-item label="最高配载" prop="perWeight">
                    <el-input-number v-model="formData.perWeight" placeholder="请输入最高配载(吨/方)" step-strictly controls-position=right :style="{width: '50%'}"></el-input-number> <span>吨/方</span>
                </el-form-item>

                <el-form-item label="运输单价" prop="shipmentPrice">
                    <el-input-number v-model="formData.shipmentPrice" placeholder="运输单价" step-strictly controls-position=right :style="{width: '50%'}"></el-input-number> <span>元/吨(不含税)</span>
                </el-form-item>
