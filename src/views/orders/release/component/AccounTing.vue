            ...
            <el-form-item label="免赔偿路耗规范">
                <div class="ui-flex">
                    <el-form-item prop="startLimitWastage">
                        ...
                        <el-input-number v-model="formData.startLimitWastage" placeholder="" step-strictly controls-position=right :style="{width: '120px'}"></el-input-number>
                        <span class="pl-5 pr-5">吨</span>
                    </el-form-item>
                    <el-form-item prop="endLimitWastage">
                        <span class="pl-5 pr-5">+</span>
                        <el-input-number v-model="formData.endLimitWastage" placeholder="" step-strictly controls-position=right :style="{width: '120px'}"></el-input-number>
                        <span class="pl-5 pr-5">吨</span>
                    </el-form-item>
