  ...
  <div>
    ...
    >
      ...
      <template v-if="formData.tin4 === '0'">
        ...
        <el-form-item v-if="formData.tin5 === '1'" label="指定接单人">
          <div class="ly-flex">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        tin5: [{ required: true, message: '选择所属项目', trigger: 'change' }],
            ...
            resolve(
              {
                ...
                'orderFreightBoList': [
                  {
                    ...
                    'goodsType': this.isMultiGoods ? this.formData.tin2_1 : this.formData.tin2_2
                    // 'orderGoodsCode': '',
                    // 'ruleItemValue': '',
                    // 'type': 0
                  }
                ...
                'orderSpecifiedList': (tin6_1.length && tin6_1) || (tin6_2.length && tin6_2) || [{
                  // 'driverInfoCode': '',
                  // 'teamInfoCode': '',
                  // 'userType': ''
                }],
