<template>
  ...
  >
    <pl-table-column v-if="!!_events['selection-change']" type="selection" width="55" align="center" fixed :selectable="selectable" :reserve-selection="reserveSelection" />
    <pl-table-column v-if="!isShowIndex" label="序号" align="center" fixed="left" type="index" width="50" />
...
<style lang="scss">
	.pl-table__empty-block{
	  text-align: left !important;
    margin-left: 50% !important;
    justify-content: left !important;
	}
  .pl-table__empty-text{
    width: auto;
  }
  .pl-table__footer-wrapper tbody td {
