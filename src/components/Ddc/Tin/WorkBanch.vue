              ...
              <div class="g-flex g-justifybetween g-alignend">
                <div class="statistic1-total margintop15" style="width: 70%;">
                  <div class="g-title-smaller">
                    <div>今日货单</div>
                    <div>
                      <span class="g-strong g-title-max"><count-to :end-val="statistic.order? (statistic.order.newOrder>0?statistic.order.newOrder:0) : 0" :decimal-places="0" /></span>
                      单
                    </div>
...
export default {
  ...
  methods: {
    ...
    initWebSocket() { // 初始化weosocket
      const wsuri = 'ws://' + process.env.VUE_APP_BASE_HOST + '/websocket/chy';// ws地址
