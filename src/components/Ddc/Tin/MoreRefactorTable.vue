<template>
  <el-table :ref="refName" v-loading="loading" :show-summary="summary" border stripe highlight-current-row :data="data" v-bind="$attrs" @selection-change="handleSelectionChange">
